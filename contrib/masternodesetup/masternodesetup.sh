...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='freco.conf'
CONFIGFOLDER='/root/.freco'
COIN_DAEMON='frecod'
COIN_CLI='freco-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/FrecoBF/Freco/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
