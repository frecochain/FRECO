...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/frecod.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/freco-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/freco-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/freco.ico %{buildroot}%{_datadir}/pixmaps/freco.ico
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/freco16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/freco32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/freco64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/freco128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/freco256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/freco256.png %{buildroot}%{_datadir}/pixmaps/freco16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/freco256.png %{buildroot}%{_datadir}/pixmaps/freco32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/freco256.png %{buildroot}%{_datadir}/pixmaps/freco64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/freco256.png %{buildroot}%{_datadir}/pixmaps/freco128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/freco256.png %{buildroot}%{_datadir}/pixmaps/freco256.xpm
