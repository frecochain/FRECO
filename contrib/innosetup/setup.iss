...
#define MyAppName "Freco"
#define MyAppPublisher "2022 Freco developers"
#define MyAppURL "https://frecotoken.com/"
#define MyAppExeName "freco-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/FRECO/bootstrap.zip"
...
[Files]
Source: ".\package\freco-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Freco\Freco-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Freco\Freco-Qt,strDataDir|{userappdata}\Freco\}');
  Result := True;
end;
