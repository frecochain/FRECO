...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FRECO features */
        {"freco", "listmasternodes", &listmasternodes, true },
        {"freco", "getmasternodecount", &getmasternodecount, true },
        {"freco", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"freco", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"freco", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"freco", "masternodecurrent", &masternodecurrent, true },
        {"freco", "startmasternode", &startmasternode, true },
        {"freco", "createmasternodekey", &createmasternodekey, true },
        {"freco", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"freco", "listmasternodeconf", &listmasternodeconf, true },
        {"freco", "getmasternodestatus", &getmasternodestatus, true },
        {"freco", "getmasternodewinners", &getmasternodewinners, true },
        {"freco", "getmasternodescores", &getmasternodescores, true },
        {"freco", "preparebudget", &preparebudget, true },
        {"freco", "submitbudget", &submitbudget, true },
        {"freco", "mnbudgetvote", &mnbudgetvote, true },
        {"freco", "getbudgetvotes", &getbudgetvotes, true },
        {"freco", "getnextsuperblock", &getnextsuperblock, true },
        {"freco", "getbudgetprojection", &getbudgetprojection, true },
        {"freco", "getbudgetinfo", &getbudgetinfo, true },
        {"freco", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"freco", "mnfinalbudget", &mnfinalbudget, true },
        {"freco", "checkbudgets", &checkbudgets, true },
        {"freco", "mnsync", &mnsync, true },
        {"freco", "spork", &spork, true },
        {"freco", "getcollateral", &getcollateral, true},
...
{
    return "> freco-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8283/\n";
}
