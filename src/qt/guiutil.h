...
/** Utility functions used by the Freco Qt UI.
 */
namespace GUIUtil
{
...
// Render FRECO addresses in monospace font
...
// Parse "freco:" URI into recipient object, return true on successful parsing
