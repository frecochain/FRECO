...
/* Freco GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Freco"
#define QAPP_ORG_DOMAIN "frecotoken.com"
#define QAPP_APP_NAME_DEFAULT "Freco-Qt"
#define QAPP_APP_NAME_TESTNET "Freco-Qt-testnet"
