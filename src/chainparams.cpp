...
{
    const char* pszTimestamp = "Freco!!! The best Memecoin";
    const CScript genesisOutputScript = CScript() << ParseHex("042c14f0bd904a30c66253415f1ce7a595ac4869c6c6a03a4ad4cf78d8b8a8063c1010e72fa4ca5012ae0c6d496401c498b409e9b4febe8649b55fc05d3adae5b9") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1691761275, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        //  uint32_t nGenesisTime = 1691761275;
        //  arith_uint256 test;
        //  bool fNegative;
        //  bool fOverflow;
        ...
        genesis = CreateGenesisBlock(1691761275, 778773, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000002f6f6f4df5b8fee4c2b313ddfb65a3ac6e00c8eb5af812344ef9af15c61"));
        assert(genesis.hashMerkleRoot == uint256S("0x8ba425b024f39a639705d8bc6c7571241502f1530ad09059c4b853247509415c"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04a04d934a38cff458ef6dfaeb7ca7660079ca491eb577ff9ab2c6d95f6c5152c026fa0b165ff7f12b21c094ad6dae036a38cc788a5e3520893befe99cfe6e0719";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.frecotoken.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.frecotoken.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.frecotoken.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.frecotoken.com"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.frecotoken.com"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.frecotoken.com"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.frecotoken.com"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.frecotoken.com"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x4f)(0x23)(0xf9)(0xe2).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x4f)(0xa4)(0x53)(0x4a).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x94)(0x0e)(0x65)(0x06).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // freco starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet freco addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet freco script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet freco BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet freco BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet freco BIP44 coin type is '1' (All coin's testnet default)
