...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zFRECO or normal UTXO
     *  zFRECO: Each zFRECO has a keypair associated with it. The serial number is a hash of the public key.
