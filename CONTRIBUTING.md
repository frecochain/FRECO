Contributing to Freco Core
============================

The Freco Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/FrecoBF/Freco/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Freco Core project, and is not to be
confused with overall Freco Network Protocol consensus changes.

Whether a pull request is merged into Freco Core rests with the project merge
...
Patches that change Freco consensus rules are considerably more involved than
...
Where a patchset proposes to change the Freco consensus, it must have been
...
The project leader is the release manager for each Freco Core release.
