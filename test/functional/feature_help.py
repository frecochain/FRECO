...
"""Verify that starting freco with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start freco with -? for help text")
        ...
        self.log.info("Start freco with -version for version information")
